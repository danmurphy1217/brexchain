...
func NewHandler(k keeper.Keeper) sdk.Handler {
	...
	return func(ctx sdk.Context, msg sdk.Msg) (*sdk.Result, error) {
		...
		case *types.MsgApproveTransaction:
			...
			return sdk.WrapServiceResult(ctx, res, err)
		case *types.MsgSendTransaction:
			res, err := msgServer.SendTransaction(sdk.WrapSDKContext(ctx), msg)
			return sdk.WrapServiceResult(ctx, res, err)
		case *types.MsgRejectTransaction:
			res, err := msgServer.RejectTransaction(sdk.WrapSDKContext(ctx), msg)
			return sdk.WrapServiceResult(ctx, res, err)

...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("cosmonaut.brexchain.txnengine.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Transaction(request) {
        const data = QueryGetTransactionRequest.encode(request).finish();
        const promise = this.rpc.request("cosmonaut.brexchain.txnengine.Query", "Transaction", data);
    ...
    TransactionAll(request) {
        ...
        const promise = this.rpc.request("cosmonaut.brexchain.txnengine.Query", "TransactionAll", data);
